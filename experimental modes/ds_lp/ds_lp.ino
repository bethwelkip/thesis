 /*************************************************************
deep sleep, low power periodic measurements
in this case we do not turn of periodic measurements.
instead, we switch to low power periodic measurements
...
void singleShot()
{
  ...
  // delay for a second(to allow data to be sent) then take a nap
  delay(1000);
...
void setup()
{
  ...
  // Setup functions to be called at intervals
